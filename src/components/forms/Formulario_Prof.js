  ...
  return (
    <Form onSubmit={handleSubmit}>
      <Form.Group  control="Preguntas_prof">
        ...
        <br/>
        <div>
          <label htmlFor="nombreProfesor">Nombre completo del profesor. </label>
          <select
            id="nombreProfesor"
            name="nombreProfesor"
        ...
        <br/>
        <div>
          <label htmlFor="asignaturaProfesor">Curso o Asignatura impartida. </label>
          <select
        ...
        <br/>
        <div>
          <label htmlFor="departamentoEnsenanza">Departamento o área de enseñanza. </label>
          <select
        ...
        <Form.Group  control="Preguntas_menu1">
          <br/>
          <h5>Por favor, califica las siguientes áreas del desempeño del profesor en una escala del 1 al 5, donde 1 es "Deficiente" y 5 es "excelente":</h5>
          <br/>
          <div>
          <label htmlFor="pregunta1_menu1">Dominio del contenido del curso.</label>
          <select
            id="pregunta1_menu1"
            ...
            onChange={handleChange}
          >
            <option value="">Seleccione su opinion</option>
          ...
          <br/>
          <div>
          <label htmlFor="pregunta2_menu1">Claridad en la entrega de las clases.</label>
          <select
            id="pregunta2_menu1"
          ...
          <br/>
          <div>
          <label htmlFor="pregunta3_menu1">Capacidad para mantener el interés de los estudiantes.</label>
          <select
            id="pregunta3_menu1"
          ...
          <br/>
          <div>
          <label htmlFor="pregunta4_menu1">Habilidad para responder preguntas y dudas.</label>
          <select
            id="pregunta4_menu1"
          ...
          <br/>
          <div>
          <label htmlFor="pregunta5_menu1">Retroalimentación y evaluación justa de los estudiantes.</label>
          <select
            id="pregunta5_menu1"
          ...
          <br/>
          <div>
          <label htmlFor="pregunta6_menu1">Disponibilidad para brindar apoyo fuera del horario de clases.</label>
          <select
            id="pregunta6_menu1"
          ...
          <br/>
          <div>
          <label htmlFor="pregunta7_menu1">Organización y estructura del curso.</label>
          <select
            id="pregunta7_menu1"
        ...
        <Form.Group>
          <br/>
          <h5>Responda las preguntas acerca de la relación del docente con el curso.</h5>
          <br/>
          <div>
          <label htmlFor="relevanciaCurso">¿Cómo describirías la relevancia del curso para tus estudios?</label>
          <select
            id="relevanciaCurso"
          ...
          <br/>
          <div>
          <label htmlFor="cumplimientoObjetivos">¿Consideras que los objetivos del curso se cumplieron satisfactoriamente?</label>
          <select
          ...
          <br/>
          <div>
          <label htmlFor="mejorasCurso">¿Qué aspectos del curso consideras que podrían mejorarse?</label>
          <br/>
          <textarea
           id="mejorasCurso" 
           name="mejorasCurso" 
          ...
          <br/>
          <div>
          <label htmlFor="quejaReclamoFelicitacion">¿Alguna queja, reclamo, felicitación o aporte adicional que desee hacer al docente?</label>
          <br/>
          <textarea
