    ...
    return (
        ...
        <div>
            ...
            <Card className="mb-4">
                ...
                <br/>
                <Col sm = "8">
                <Card.Text className="text-muted mb-4"><h4>{graduado.address?.street},{graduado.address?.city}</h4></Card.Text>
                </Col>
            ...
            <div>
                ...
                <CardGroup>
                    ...
                    <Col sm="9">
                        <Card.Text className="text-muted">{graduado.phone}</Card.Text>
                    </Col>
                    </Row>
                    <hr />
                    <br/>
                    ...
                    <Col sm="9">
                        <Card.Text className="text-muted">{graduado.address?.street}, {graduado.address?.city}</Card.Text>
                    </Col>
                    </Row>
                    <br/>
                    <Row>
                    ...
                    <Col sm="9">
                        <Card.Text className="text-muted">{graduado.company?.name}</Card.Text>
                    </Col>
                    </Row>
                </CardGroup>
                </Card>
